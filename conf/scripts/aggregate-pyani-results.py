...
def main(args):
    ...
    for path in allpaths:
        ...
        for rank in compare_ranklist:
            ...
            pyani_ident = idD.at[anchor_acc, compare_acc]
            pyani_coverage = covD.at[anchor_acc, compare_acc]
            pyani_aln_length = lenD.at[anchor_acc, compare_acc]
            pyani_sim_errors = seD.at[anchor_acc, compare_acc]
            pyani_hadamard = hadD.at[anchor_acc, compare_acc]
